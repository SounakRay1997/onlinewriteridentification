...
model=load_model('autoencoder_best_seq_len_bs_20-0.00019.h5')
chk = ModelCheckpoint('autoencoder_best_seq_len_bs_20-{val_loss:.6f}.h5', verbose=1, monitor='val_loss', save_best_only=True, mode="min")
